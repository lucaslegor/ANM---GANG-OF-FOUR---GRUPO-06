  ...
  const theories = {
    ...
    power: {
      ...
      steps: [
        ...
        "Se define Y = ln(y), X = ln(x), α = ln(a), β = b",
        "Se aplica regresión lineal a los datos transformados",
        "Se busca una función de la forma: Y = α + βx",
        "Se calculan las sumas necesarias: ΣX, ΣY, ΣXY, ΣX², y es necesario conocer n",
        "Se resuelven las ecuaciones normales para encontrar α y β",
        "β = (nΣxy - ΣxΣy) / (nΣx² - (Σx)²)",
        "α = (Σy - βΣx) / n",
        "Se recuperan los parámetros originales: a = e^α, b=β",
      ],
    },
  }
